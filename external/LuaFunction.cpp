...
LuaFunction::LuaFunction(): LuaRef(), trackback_(0)
{
}

LuaFunction::LuaFunction(lua_State* aL, int index, int) : LuaRef(aL, index), trackback_(0)
{
...
void LuaFunction::pusharg(unsigned int v) const
{
	lua_pushinteger(L, v);
}
